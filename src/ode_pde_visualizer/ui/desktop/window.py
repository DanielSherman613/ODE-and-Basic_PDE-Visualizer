...
from ode_pde_visualizer.presets.ode_presets import buildLorenzModel, buildLotkaVolterraModel
...
class DesktopMainWindow(QMainWindow):
    ...
    def _onSystemSelectionChanged(self, systemName: str) -> None:
        ...
        elif systemName == "Lorenz":
            self.controller.loadModel(buildLorenzModel(), clearExpression=True)
        elif systemName == "Lotka Volterra":
            self.controller.loadModel(buildLotkaVolterraModel(), clearExpression=True)
        else:
            return
