...
from ode_pde_visualizer.src.ode_pde_visualizer.core.projection import \
    ProjectionResult, ProjectionEngine
from ode_pde_visualizer.src.ode_pde_visualizer.core.time_series import \
    PDETimeSeries
from ode_pde_visualizer.src.ode_pde_visualizer.core.view_state import ViewState
from ode_pde_visualizer.src.ode_pde_visualizer.rendering.color_policy import \
    ScalarColorPolicy
...
class SceneRenderer(Protocol):
    def render(self, projection: ProjectionResult, colorPolicy: ScalarColorPolicy) -> None:
        ...
